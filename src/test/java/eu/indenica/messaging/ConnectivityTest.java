...
public class ConnectivityTest {
	...
	public void testSimpleConnection() throws Exception {
		...
		assertThat(msgWaitLock.tryAcquire(TIMEOUT, TimeUnit.SECONDS), is(true));
		...
		msgWaitLock.tryAcquire(nEvents, TIMEOUT, TimeUnit.SECONDS);
	...
	public void testMcastDiscovery() throws Exception {
		PubSub mcastPubSub = new CustomBrokerUriPubSub(
		...
		e = new EventOne();
		defaultPubSub.publish(null, e);
		msgWaitLock.tryAcquire(2, TIMEOUT, TimeUnit.SECONDS);
	...
	public void testBrokerDiscovery() throws Exception {
		...
		PubSub secondPubSub = new CustomBrokerUriPubSub(URI.create(secondBroker
				.getConnectString()));
